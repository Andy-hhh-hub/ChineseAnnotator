...
def compareBoundary(gold_file, pred_file, out_file):
    ...
    out_file.write(
        "File1 color: " + "\colorbox{blue!30}{Blue}; Dir: \colorbox{blue!30}{" + gold_file + "}" + '\\\\' + '\n')
    out_file.write(
        "File2 color: " + "\colorbox{red!30}{Red}; Dir: \colorbox{red!30}{" + pred_file + "}" + '\\\\' + '\n')
...
def entity_overlap_span(gold_entity, pred_entity):
    ...
    if gold_set.intersection(pred_set):
        ...
        return "O[" + str(start) + "," + str(end) + "]_G[" + str(gold_start) + "," + str(
            gold_end) + "]:" + gold_type + "_P[" + str(pred_start) + "," + str(pred_end) + "]:" + pred_type
    else:
        return -1
